...
class MyEventController extends Controller
{
    public function index()
    {
        ...
        return view('faculty.my-events.index', compact('events'));
    }
    
    public function create()
    {
        $facultyMembers = User::where('role', 'faculty')->orderBy('name')->get();
        return view('faculty.my-events.create', compact('facultyMembers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($existing) {
            return redirect()->route('faculty.my-events.index')
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Event Submission Failed: ' . $e->getMessage() . "\n" . $e->getTraceAsString());
            return back()->with('error', 'Failed to submit event: ' . $e->getMessage());
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('faculty.my-events.show', compact('event'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('faculty.my-events.edit', compact('event'));
    }
    ...
    public function downloadApproval($id)
    {
        ...
        return view('faculty.my-events.pdf-approval', compact('event', 'hod'));
    }
}
