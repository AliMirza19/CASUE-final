    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-2">
                <a href="{{ route('hod.my-events.index') }}" class="text-gray-600 hover:text-gray-900 mr-3">
            ...
            <p class="text-gray-600 ml-9">Submit a new event proposal (This will be self-approved automatically)</p>
        </div>

        <form action="{{ route('hod.my-events.store') }}" method="POST" id="eventForm">
            @csrf
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('hod.my-events.index') }}" 
