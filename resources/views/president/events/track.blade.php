                                ...
                                @foreach($events->get($status) as $event)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-sm text-center">
                                            @if($event->created_by_role === 'president')
                                                <a href="{{ route('president.my-events.show', $event->id) }}" class="text-cause-purple hover:text-purple-700 font-semibold">View</a>
                                            @elseif($status === 'pending_president')
                                                <a href="{{ route('president.review', $event->id) }}" class="text-cause-purple hover:text-purple-700 font-semibold">Review</a>
                                            @else
