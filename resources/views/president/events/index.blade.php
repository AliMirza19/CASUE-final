    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-1">Events created by you as President</p>
            </div>
            <a href="{{ route('president.my-events.create') }}" 
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="ml-4">
                                    @php
                                        $statusConfig = [
                                            'pending_patron' => ['bg' => 'bg-yellow-100', 'text' => 'text-yellow-800', 'label' => 'Pending Patron'],
                            ...
                            <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                                ...
                                <a href="{{ route('president.my-events.show', $event->id) }}" 
