...
<div class="py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 ml-9">Submit a new event proposal (will be sent to Patron for review)</p>
        </div>

        <form action="{{ route('president.my-events.store') }}" method="POST" id="eventForm">
            @csrf
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('president.my-events.index') }}" 
