...
<div class="mt-4 px-4 py-2 text-xs font-bold text-gray-400 uppercase tracking-wider">Smart Ingestion</div>
<a href="{{ route('admin.import.students') }}" class="sidebar-link {{ request()->routeIs('admin.import.students') ? 'active' : '' }} flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 mt-2">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
    </svg>
    Import Students
...
<a href="{{ route('admin.import.faculty') }}" class="sidebar-link {{ request()->routeIs('admin.import.faculty') ? 'active' : '' }} flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 mt-2">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
