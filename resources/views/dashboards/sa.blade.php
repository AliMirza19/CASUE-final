...
@section('title', 'SA Dashboard - CAUSE Smart Society')
@section('page-title', 'Student Affairs Dashboard')
@section('page-description', 'Final event approvals and oversight')

@section('sidebar')
    <a href="{{ route('sa.dashboard') }}" class="sidebar-link active flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100">
...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2">{{ $totalApproved }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-cause-purple">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm font-medium">Budget Approved</p>
                    <p class="text-2xl font-bold text-gray-800 mt-2">PKR {{ number_format($totalBudgetApproved, 0) }}</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-200 bg-yellow-50">
            <h3 class="text-lg font-semibold text-gray-800">Events Pending Final Approval</h3>
            <p class="text-gray-600 text-sm mt-1">Review HOD-approved events and grant final approval</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($pendingEvents as $event)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('sa.review', $event->id) }}" 
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">No events pending approval</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
