...
@section('content')
    <form action="{{ route('faculty.my-events.store') }}" method="POST" id="eventForm">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow-md p-6 flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('faculty.my-events.index') }}" class="bg-gray-200 text-gray-800 px-6 py-2 rounded-lg font-medium hover:bg-gray-300">Cancel</a>
                <button type="submit" 
