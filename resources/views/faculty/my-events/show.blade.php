...
@section('content')
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('faculty.my-events.index') }}" class="text-cause-purple hover:text-purple-700 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                ...
                <a href="{{ route('faculty.my-events.edit', $event->id) }}" 
                   class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center inline-flex">
