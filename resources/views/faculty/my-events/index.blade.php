...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('faculty.my-events.create') }}" class="bg-cause-purple hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('faculty.my-events.show', $event->id) }}" class="text-blue-600 hover:text-blue-800" title="View">
                                    ...
                                    @if(in_array($event->status, ['revision_needed', 'pending_president']))
                                        <a href="{{ route('faculty.my-events.edit', $event->id) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if($event->status === 'president_approved')
                                        <form action="{{ route('faculty.my-events.forward', $event->id) }}" method="POST" class="inline">
                                            @csrf
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <a href="{{ route('faculty.my-events.create') }}" class="bg-cause-purple hover:bg-purple-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                    </svg>
